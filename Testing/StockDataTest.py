"""pandas_datareader is not currently working"""
...
class TestGetStockData(unittest.TestCase):
    @classmethod
    def setUpClass(self):
        """We only eant to pull this data once for each TestCase since it is an expensive operation"""
    ...
    def test_high_low(self):
        """ensure high and low are the highest and the lowest in the same row"""
